...
public class WikiPhilosophyCompleted {
	 ...
	 * @param paragraphs
	 */
    public WikiPhilosophyCompleted(Elements paragraphs) {
	...
	public static Element getFirstValidLink(String url) throws IOException {
        ...
        WikiPhilosophyCompleted wp = new WikiPhilosophyCompleted(paragraphs);
